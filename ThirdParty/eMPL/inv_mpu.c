 ...
 * min(int a, int b)
 */
#if defined EMPL_TARGET_MSPM0
#include "BSP/MPU6050/mpu6050_empl_port.h"
#define i2c_write MPU6050_eMPL_i2cWrite
#define i2c_read MPU6050_eMPL_i2cRead
#define delay_ms MPU6050_eMPL_delayMs
#define get_ms MPU6050_eMPL_getMs
#define log_i(...) MPU6050_EMPL_LOG_INFO(__VA_ARGS__)
#define log_e(...) MPU6050_EMPL_LOG_ERROR(__VA_ARGS__)
#define fabs fabsf
...
#if defined EMPL_SENSOR_MPU6050
#define MPU6050
#endif
 ...
 *  @}
 */
#endif /* ATTITUDE_FILTER_IMPL_DMP */
