...
// BMI270 vendor config RAM blob (8192 bytes). Burst-written to INIT_DATA (0x5E)
// during Bmi270::begin(). DO NOT modify a single byte — this is Bosch-supplied
// firmware configuration data. Source: gitcode.com/Benjamin123456/bmi270
// (Extend/inc/BMI270_config.h). See ThirdParty/bmi270/README.md.
